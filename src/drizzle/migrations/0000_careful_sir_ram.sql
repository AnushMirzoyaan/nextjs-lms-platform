...
ALTER TABLE "course_products" ADD CONSTRAINT "course_products_productId_productses_id_fk" FOREIGN KEY ("productId") REFERENCES "public"."productses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
